/**
 * Modelo de una receta de café.
 * (Proyecto en JavaScript puro — se documenta con JSDoc en lugar de una
 * interface de TypeScript, pero cumple el mismo propósito de tipado.)
 *
 * @typedef {Object} CoffeeRecipe
 ...
 * @property {string} ctaHref       Destino del CTA (ruta o ancla existente).
 */
